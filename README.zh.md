...
> 这是 `react-native-splash-screen` 的 `v4` 升级版本，仅支持 React Native 新架构。
...
`v4.x` 不支持旧架构（Legacy Architecture）。
...
完整示例（`AppDelegate.swift`，RN 0.84 模板）：
...
`v3.x` 文档和历史接入方式请参考 [README.zh-v3.md](./README.zh-v3.md)。
